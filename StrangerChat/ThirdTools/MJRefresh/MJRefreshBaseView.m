...
- (void)settingLabelText
{
	switch (self.state) {
		case MJRefreshStateNormal:
            ...
            self.statusLabel.textColor = [UIColor colorWithRed:236/255.0 green:49/255.0 blue:88/255.0 alpha:1];// 改颜色
			break;
		case MJRefreshStatePulling:
            // 设置文字
            self.statusLabel.text = self.releaseToRefreshText;
            self.statusLabel.textColor = [UIColor colorWithRed:236/255.0 green:49/255.0 blue:88/255.0 alpha:1];
			break;
