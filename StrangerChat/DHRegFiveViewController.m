...
@interface DHRegFiveViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
@implementation DHRegFiveViewController
 ...
 */
- (void)nextStep{
    DHRegSixViewController *vc = [[DHRegSixViewController alloc]init];
    vc.gender = _gender;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSArray *dict = [NSGetSystemTools getfavorite1Array];
    // 保存注册兴趣
    [[NSUserDefaults standardUserDefaults] setObject:dict[indexPath.item] forKey:@"regInterest"];
