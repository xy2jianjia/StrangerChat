...
#import "TouchmeCell.h"
#import "TouchModel.h"
#import "Homepage.h"
@interface TouchMeController ()<UITableViewDelegate,UITableViewDataSource> {
    
    UITableView *paraTabelView;
}
@property (nonatomic,strong)NSString *titleStr;  // 计算文字宽度
@property (nonatomic,strong)NSString *ageStr;  // 计算文字宽度
@property (nonatomic,strong)NSMutableArray *touchMeArray;

@end

@implementation TouchMeController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.touchMeArray = [NSMutableArray array];
...
- (void)layoutParallax
{
    ...
    [paraTabelView registerClass:[TouchmeCell class] forCellReuseIdentifier:@"cell"];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return self.touchMeArray.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    
    TouchModel *touch = self.touchMeArray[indexPath.row];
    TouchmeCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell" forIndexPath:indexPath];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [TouchmeCell touchmeCellHeight];
}
