...
@property (nonatomic,strong) NSNumber *b95;// 当前页数
@property (nonatomic,strong) NSNumber *b96;// 是否有下一页,0:没有 1:有
...
@property (nonatomic,strong) NSNumber *b24;// 兴趣爱好-----
...
@property (nonatomic,strong) NSNumber *b37;// 个性特征-----
